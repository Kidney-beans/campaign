<template>
  <div class='colorful-circle-frame' :style="{'width':SideLength + 'px','height':SideLength + 'px'}">
      <div class="outter-circle" :style="{'width':SideLength + 'px','height':SideLength + 'px'}">
        <div class="inner-circle" :style="{'width':SideLength - SideWidth + 'px','height':SideLength - SideWidth + 'px'}">
        </div>
      </div>
